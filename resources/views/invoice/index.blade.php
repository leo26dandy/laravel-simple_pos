                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <a href="{{ url('/invoice/create') }}" class="btn btn-primary btn-sm float-right">Tambah Data</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('invoice.destroy', $row->id) }}" method="POST">
                                                @method('DELETE')
                                                @csrf
                                                <a href="{{ route('invoice.print', $row->id) }}" class="btn btn-secondary btn-sm">Cetak</a>
