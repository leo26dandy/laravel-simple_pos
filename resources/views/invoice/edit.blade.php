                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="text-center">
                                    {{-- <img src="/svg/document.svg" style="height: 30px;"> --}}
                                    {{-- <img src="{{ asset('svg/smartphone.svg') }}" alt="" width="350px" height="150px"> --}}
                                </div>
                            </div>
                            <div class="col-md-6">
                                <table>
                            ...
                            <div class="col-md-6">
                                <table>
                                    ...
                                    <tr>
                                        <td>Email</td>
                                        <td>:</td>
                                        <td>support@jayaselalu.com</td>
                                    </tr>
                                </table>
                            </div>
                            <div class="col-md-12 mt-3">
                                <form action="{{ url('/invoice/'.$invoice->id) }}" method="post">{{-- {{ route('invoice.update', ['id' => $invoice->id]) }} --}}
                                @csrf 
                                <table class="table table-hover table-bordered">
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="number" min="1" value="1" name="banyak_brg" class="form-control" required>
                                            </td>
                                            <td colspan="3">
